use Appwrite_axum::axum::{routing::get, Router, response::IntoResponse};
use regex::Regex;
...
use Appwrite_runtime::SecretStore;
...
#[Appwrite_runtime::main]
async fn main(#[Appwrite_runtime::Secrets] secrets: SecretStore) -> Appwrite_axum::AppwriteAxum {
    // 将从 Appwrite SecretStore 获取的机密设置为环境变量
